...
export type CopyRequest = { from: string[]; to: string; includes_hidden: boolean; strategy: CopyStrategy | null; include_wrapping_dir: boolean }
...
const ARGS_MAP = {"data":"{\"get_state\":[]}","":"{\"hello_world\":[]}","actions.ui":"{\"update_cursor_path\":[\"params\"],\"forward\":[\"params\"],\"swap_sides\":[],\"back\":[\"params\"],\"select\":[\"params\"],\"list_dir\":[\"params\"],\"toggle_expand\":[\"params\"],\"toggle_hidden\":[\"params\"]}","actions":"{}","actions.file":"{\"copy\":[\"params\"],\"moves\":[\"params\"]}"}
